...
* @property Messagemodel             $pbookmodel
*/

class Pbook extends Admin_Controller
{
    /**
     * constructor
     */
    ...
    public function edit($id)
    {
        ...
        try
        {
            ...
            if($this->input->post("submit")){
                ...
                {
                    $message = $this->mapper->formToMessage($this->input,$this->data["message_form"],$this->pbookmodel->get($id));
                    if($this->pbookmodel->save($message))
                    {
            ...
            $this->data["message"]       = $this->pbookmodel->get($id);
            $this->data["action_url"] = base_url()."admin/pbook/edit/".$id;
    ...
    public function add()
    {
        ...
        try
        {
            ...
            $this->data["action_url"] = base_url()."admin/pbook/add";
            $this->data["message"]    = new PdPbook();
            return $this->view();
        }
        catch (Exception $err)
        {
    ...
    public function delete()
    {
        ...
        { 
            if($this->input->post("delete")){
                $this->pbookmodel->delete($this->input->post("id"));
            }

            redirect(base_url()."admin/pbook");        
        }
        catch (Exception $err)
        {
            log_message("error", $err->getMessage());
